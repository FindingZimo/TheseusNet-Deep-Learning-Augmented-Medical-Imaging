...
settings['drop_out_rate'] = 0.2 #0.35
EPOCHS = 50
batch_size = 8
NUM_VALIDATIONS = 1

model = VGG19(input_specs, settings)
DESTINATION = 'D:/Folder of things for Zimo/Runs/Week9/testcases'
...
for ii in range(NUM_VALIDATIONS):
    ...
    model = VGG19(input_specs, settings)
    model.compile(optimizer = Adam(lr = 1e-5, decay = 0.001), #decay rate = 0.01
